...
sys.path = ["/home/matt/Code/Tools/organizer/lib/python2.7/site-packages"] + sys.path

# Add this app's directory to the PYTHONPATH
#sys.path.append('/home/matt/Code/Tools/organizer')
sys.path = ['/home/matt/Code/Tools/organizer'] + sys.path
#sys.path.append('/home/matt/Code/Tools/organizer/organizer')
sys.path = ['/home/matt/Code/Tools/organizer/organizer'] + sys.path
#sys.path.append('/home/matt/Code/Tools/organizer/organizer/organizer')
sys.path = ['/home/matt/Code/Tools/organizer/organizer/organizer'] + sys.path
...
activate_env = "/home/matt/Code/Tools/organizer/bin/activate_this.py"
